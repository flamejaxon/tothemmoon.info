...
a.dd&&(c=null);var d=(0,g.x)(a.tO,a);c||(c=new g.Xm("//www.google.com/images/cleardot.gif"),Z5(c));tua(c.toString(),1E4,d)}else C6(2);Rua(a,b)},Rua=function(a,b){a.o=0;
...
c&&(c.receiverType!=chrome.cast.ReceiverType.CUSTOM&&(c=new chrome.cast.Receiver(c.label,c.friendlyName),c.receiverType=chrome.cast.ReceiverType.CUSTOM),a.push(c));return a},Bva=function(a,b,c,d,e,f,k){wva()?xva(b,e,f,k)&&(I7(!0),window.chrome&&chrome.cast&&chrome.cast.isAvailable?yva(a,c):(window.__onGCastApiAvailable=function(l,m){l?yva(a,c):(J7("Failed to load cast API: "+m),K7(!1),I7(!1),l6("yt-remote-cast-available"),l6("yt-remote-cast-receiver"),zva(),c(!1))},d?g.Hp("https://www.gstatic.com/cv/js/sender/v1/cast_sender.js"):
